...
void Comision::setProfe(const char *p) {
    strcpy(profe, p);
}

void Comision::setAula(const char *a) {
    strcpy(aula, a);
}

void Comision::setCodComision(int c) {
    codComi = c;
}

void Comision::setCantidad(int c) {
    cantidad = c;
}

void Comision::setEstado(bool e) {
    estado = e;
}

void Comision::setCodDep(int c) {
    codDep = c;
}

void Comision::setNumero(int n) {
    numero = n;
}

const char *Comision::getProfe() {
    return profe;
}

const char *Comision::getAula() {
    return aula;
}

int Comision::getCodComision() {
    return codComi;
}

int Comision::getCantidad() {
    return cantidad;
}

bool Comision::getEstado() {
    return estado;
}

int Comision::getCodDep() {
    return codDep;
}

int Comision::getNumero() {
    return numero;
}
