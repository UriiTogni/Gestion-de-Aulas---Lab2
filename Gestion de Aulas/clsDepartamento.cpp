...
void Departamento::setNombre(const char *n) {
    strcpy(nombre, n);
}

void Departamento::setEstado(bool e) {
    estado = e;
}

void Departamento::setNumero(int n) {
    numero = n;
}

void Departamento::setCodigo(int c) {
    codigo = c;
}

const char *Departamento::getNombre() {
    return nombre;
}

bool Departamento::getEscritura() {
    return escritura;
}

bool Departamento::getLectura() {
    return lectura;
}

bool Departamento::getEstado() {
    return estado;
}

int Departamento::getNumero() {
    return numero;
}
