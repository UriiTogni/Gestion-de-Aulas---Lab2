...
void Ingreso()
{
    ...
    for(int i = 0; i < tam; i++)
    {
        ...
        if(aux.getLegajo() == legajo && aux.getLegajo() != 0)
        {
            ...
            {
                locate(75, 8); setColor(4);
                cout << "INGRESE NUEVAMENTE!!!";
                locate(70, 10);
                cout << "Legajo dado de baja"; setColor(0);
                locate(70, 12);system("pause"); system("cls");
            }
        }
    }
    ...
    if(!encontro)
    {
        ...
        cout << "INGRESE NUEVAMENTE!!!";
        locate(70, 10);
        cout << "El Legajo no figura en el sistema"; setColor(0);
        locate(70, 12);system("pause"); system("cls");
    }
}
...
void IngresoAdmin()
{
    ...
    if(!entro)
    {
      locate(70, 8); cout << "Contrasena erronea";
      locate(70, 9);system("pause");
      locate(70, 10);system("cls");
    }
